...
import 'package:flutter_demo/models/category.dart';
import 'package:flutter_demo/models/doctor.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
        ...
        BottomNavigationBarItem(
            ...
            label: ''),
        BottomNavigationBarItem(
            icon: SvgPicture.asset('assets/vectors/add-square-bold.svg'),
            label: ''),
      ]),
      appBar: AppBar(
